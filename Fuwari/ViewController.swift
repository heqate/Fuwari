...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        for screen in NSScreen.screens()! {
            let fullScreenWindow = FullScreenWindow(contentRect: NSRect(x: screen.frame.origin.x, y: screen.frame.origin.y, width: screen.frame.width, height: screen.frame.height), styleMask: .borderless, backing: .buffered, defer: false)
            fullScreenWindow.captureDelegate = self
            print(screen.frame, fullScreenWindow.frame)
